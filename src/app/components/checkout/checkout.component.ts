...
export class CheckoutComponent implements OnInit {
      ...
      customer: this.formBuilder.group({
        firstName: [
          ...
          [
            ...
            EcommerceShopValidators.notOnlyWhitespace,
          ],
        ],
        lastName: [
          '',
  ...
  copyShippingAddressToBillingAddress(event) {
    ...
    if (isChecked) {
      ...
      this.billingAddressStates = this.shippingAddressStates; // This code is needed extra
    } else {
      this.checkoutFormGroup.controls['billingAddress'].reset();
      this.billingAddressStates = []; // This code is needed extra
    }
  }
  onSubmit() {
